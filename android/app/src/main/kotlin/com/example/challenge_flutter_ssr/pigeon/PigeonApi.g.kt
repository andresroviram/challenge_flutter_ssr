...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): NotificationPayload {
      ...
      return NotificationPayload(id, title, message)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
interface NotificationApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: NotificationApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.challenge_flutter_ssr.NotificationApi.showNotification$separatedMessageChannelSuffix", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.challenge_flutter_ssr.NotificationApi.requestNotificationPermissions$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            api.requestNotificationPermissions{ result: Result<Boolean> ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.challenge_flutter_ssr.NotificationApi.openNotificationSettings$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
...
class NotificationCallback(private val binaryMessenger: BinaryMessenger, private val messageChannelSuffix: String = "") {
  companion object {
    /** The codec used by NotificationCallback. */
    val codec: MessageCodec<Any?> by lazy {
      PigeonApiPigeonCodec()
    }
  }
  fun onNotificationReceived(payloadArg: NotificationPayload, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.challenge_flutter_ssr.NotificationCallback.onNotificationReceived$separatedMessageChannelSuffix"
